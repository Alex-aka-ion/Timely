...
type Store interface {
	...
	// GetAllUsers возвращает вообще всех зарегистрированных пользователей,
	// включая уже привязанных к одному или нескольким ученикам — в отличие
	// от GetUnlinkedUsers. Нужен для "Добавить родителя" в карточке
	// ученика: один родитель может водить к нам двоих детей на разное
	// время занятий, и тогда его для второго ученика нужно найти среди уже
	// зарегистрированных, а не заводить второй Telegram-аккаунт.
